     ...
     <div class="container">
       ...
       <div class="collapse navbar-collapse navbar-right" id="menu">
          <ul class="nav navbar-nav">
            ...
            <li class="lien"><a href="about_view.php"><i class="fa fa-bookmark sr-icons"></i> About</a></li>
        ...
        <div class="col-xs-12 col-sm-8 row">
           <div class="col-xs-12 col-sm-12">
             <div class="post">
               ...
               <div class="post-body">
                 <h3><a href="simgle_post_view.php"><strong>doloremque illum</strong></a></h3>
                 <hr>
               ...
               <div class="post-footer">
                 <a class="btn" href="simgle_post_view.php">READ MORE...</a>
                 <span>
           ...
           <div class="col-xs-12 col-sm-12">
             <div class="post">
               ...
               <div class="post-body">
                 <h3><a href="simgle_post_view.php"><strong>Lorem ipsum</strong></a></h3>
                 <hr>
           ...
           <div class="col-xs-12 col-sm-12">
             <div class="post">
               ...
               <div class="post-body">
                 <h3><a href="simgle_post_view.php"><strong>Aliquam soluta</strong></a></h3>
                 <hr>
            ...
            <hr>
             <div class="post">
               ...
               <div class="post-body">
                 ...
                 <h4 class="text-left"><a href="simgle_post_view.php"><strong>Aliquam soluta</strong></a></h4>
               </div>
             </div>
             <div class="post">
               <div class="post-heading">
               ...
               <div class="post-body">
                 ...
                 <h4 class="text-left"><a href="simgle_post_view.php"><strong>Consequuntur</strong></a></h4>
               </div>
             </div>
        </div>
      <!-- End of Side bar --> 
